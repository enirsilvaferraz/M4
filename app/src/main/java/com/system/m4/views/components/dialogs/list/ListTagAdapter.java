 ...
 *
 */
class ListTagAdapter extends RecyclerView.Adapter<ListTagAdapter.ItemViewHolder> {

    private final ListComponentContract.Presenter presenter;
    private List<VOInterface> list;
    private ListTagAdapter.ItemViewHolder markedViewHolder;

    ListTagAdapter(List<VOInterface> list, ListComponentContract.Presenter presenter) {
        this.list = list;
