package com.system.m4.kotlin.view.viewholders
...
import com.system.m4.labs.chart.CustomBarChart
...
class ViewHolderTransaction private constructor(itemView: View) : CustomViewHolder<TransactionVO>(itemView) {
    ...
    override fun bind(vo: TransactionVO) {
        ...
        var content = if (vo.content.isNullOrBlank()) vo.tag.parentName else vo.content
        ...
        val itemColor = if (vo.isAlreadyPaid) R.color.item_default else R.color.item_pinned
